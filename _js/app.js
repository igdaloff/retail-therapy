...
$('.signup-btn').on('click', function(e){
	...
	$signupContainer.one('transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd', function() {
	 $signupContainer.addClass('transition-complete');
	});
});
